...
def parse_args(args=None):
    ...
    parser.add_argument('--model', default='GoldE', type=str)
    parser.add_argument('-de', '--double_entity_embedding', action='store_true')
    parser.add_argument('-dr', '--double_relation_embedding', action='store_true')
    parser.add_argument('-sf', '--self_filter', action='store_true')
    parser.add_argument('-pb', '--p_bias', action='store_true')
    parser.add_argument('-nl', '--normalize', action='store_true')
    parser.add_argument('-mp', '--map', default='exp', type=str)
    
    parser.add_argument('-n', '--negative_sample_size', default=128, type=int)
    parser.add_argument('-d', '--hidden_dim', default=500, type=int)
    parser.add_argument('-hd', '--house_dim', default=1, type=int)
    parser.add_argument('-hn', '--house_num', default=2, type=int)
    parser.add_argument('-dn', '--housd_num', default=1, type=int)

    parser.add_argument('-p', '--p_num', default=12, type=int)
    parser.add_argument('-q', '--q_num', default=3, type=int)

    parser.add_argument('-en', '--e_norm', default=1.5, type=float)
    parser.add_argument('-rn', '--r_norm', default=0.99, type=float)
    parser.add_argument('-sw', '--s_weight', default=1.0, type=float)
    parser.add_argument('-hw', '--h_weight', default=1.0, type=float)
    parser.add_argument('-ei', '--ell_min', default=1.0, type=float)
    parser.add_argument('-ea', '--ell_max', default=1.0, type=float)
...
def objective():
    ...
    args.house_dim = args.p_num + args.q_num
